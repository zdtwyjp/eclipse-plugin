...
public class OpenGeneratorWizardAction extends AbstractOpenWizardAction {
	...
	public OpenGeneratorWizardAction() {
		setText(Constants.OpenNewClassWizardAction_text);
		setDescription(Constants.OpenNewClassWizardAction_description);
		setToolTipText(Constants.OpenNewClassWizardAction_tooltip);
